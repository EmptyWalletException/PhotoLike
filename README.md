...
4 : 百度富文本编辑器需要配置一下文件上传请求路径，在/resources/static/js文件下有两个js文件：storyContribute.js文件的115行和eventContribute.js文件的115行都需要修改,默认是localhost,一般情况下不需要改动,如果后台处理上传图片请求的url修改了则需要同时修改此处的代码;
