package com.kingguanzhang.toptalk.essay.controller;
    ...
    public String toEssayPage(Model model, HttpServletRequest request, @RequestParam(name="pn",defaultValue = "1")Integer pn){
        ...
        if (null != request.getParameter("essayId")) {
            ...
            if (null == upEssay){
                 ...
                 */
                if (upEssay.getStatus().equals(1) || VerifyAuthority.isAdmin(request) || VerifyAuthority.isAuthorForThisEssay(request,upEssay)) {
